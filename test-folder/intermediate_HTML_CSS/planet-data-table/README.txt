This is a practice exercise for tables
Here is the lin <https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Structuring_content/Planet_data_table>
...
Mercury 0.330 4,879 5427 3.7 4222.6 57.9 167 0 ClosesttotheSun
Venus 4.87 12,104 5243 8.9 2802.0 108.2 464 0
Earth 5.97 12,756 5514 9.8 24.0 149.6 15 1 Ourworld
Mars 0.642 6,792 3933 3.7 24.7 227.9 -65 2 Theredplanet
...
function tdMaker(array){
                let newArray = []
    for(let i =0 ; i <array.length; i++){
        newArray[i] = `<td>${array[i]}</td>`
    };
